...
def run_test_count_cosines_from():
    ...
    # Test 4:
    expected = 2
    answer = count_cosines_from(3, 10, 0.5)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 3
    answer = count_cosines_from(2, 9, 0.18)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 7
    answer = count_cosines_from(0, 12, 0)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 0.90225  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(8, 18)
