...
#
#            for k in range(r - 1):
#            for k in range(r): I would use this range formula.
#            for k in range(r + 1):
#
...
#            for _ in range(n):
#        What does the   _   (underscore) mean? The loop does not use an index variable.
#
...
#
#
#           The first attempt is correct and the second attempt is incorrect.
#
###############################################################################
